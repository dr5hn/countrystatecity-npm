...
import type { INearbyResult, SearchResultType } from '@countrystatecity/sdk';
  ...
  program
    ...
    .action(
      async (
        ...
        const { data, usage } = await call((client) =>
          client.search.nearby({
            lat,
            lng,
            type: options.type as SearchResultType,
